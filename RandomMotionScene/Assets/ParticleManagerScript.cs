...
{
    // Hardcoded values
    private const int numberOfParticles = 30; // Number of particles
    private const float radius = 1.7f; // Radius of the cylinder
    private const float length = 10.0f; // Length of the cylinder
